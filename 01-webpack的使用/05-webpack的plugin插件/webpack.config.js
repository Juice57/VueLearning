...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.vue$/,
        use: ['vue-loader']   //vue-loader版本如果在14以上 需要另外配置插件plugin
      }
    ]
  },
  resolve: {  //配置这个来解决使用的是runtime-only而不是runtime-compiler
    extensions: ['.js','.vue','.css'],  //省略写拓展名
    //  alias 别名
    alias: {
  ...
  plugins: [
      new webpack.BannerPlugin('最终版权归sss所有'),
